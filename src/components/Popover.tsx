...
export default function PopoverExample() {
  return (
    <div className="bg-gradient-to-r from-orange-400 to-pink-600 p-8 w-full h-full flex justify-center items-start">
      <DialogTrigger>
        <Button
          aria-label="Notifications"
          className="inline-flex items-center justify-center rounded-md bg-black bg-opacity-20 bg-clip-padding border border-white/20 p-3 font-medium text-white hover:bg-opacity-30 pressed:bg-opacity-40 transition-colors cursor-default outline-none focus-visible:ring-2 focus-visible:ring-white/75"
        >
